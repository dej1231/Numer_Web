    ...
    render(){
        return(
            <div className='allincompo'>
                <h2>Cubic-spline</h2>
                <div>
                    <Button className='button_layout' type="primary" onClick={this.AddMatrix}>Add Point</Button>
                    <Button className='button_layout' type="primary" onClick={this.DelMatrix}>Delete Point</Button>
