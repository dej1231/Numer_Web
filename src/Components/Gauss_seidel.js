...
let apiUrl = "http://localhost:4040/data/matrix/Gauss_seidel_interation"
...
class Gauss_seidel extends React.Component{
    ...
    render(){
        return(
            <div className='allincompo'>
                <h2>Gauss seidel interation</h2>
                <Button className='button_layout' type="primary" onClick={this.AddMatrix}>Add row/column</Button>
                <Button className='button_layout' type="primary" onClick={this.DelMatrix}>Delete row/column</Button>
                <Button className='button_layout' type="primary" onClick={this.Calculate}>Calculate</Button>
